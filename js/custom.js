document.addEventListener("DOMContentLoaded", function() {
  ...
  // Fix koro color
  document.querySelectorAll('.koro').forEach(koro => {
    const bgColor = koro.style.backgroundColor;
    console.log(bgColor);
    if(bgColor) {
      koro.setAttribute('data-color', bgColor);
      koro.style.color = bgColor;
      koro.querySelector('.wp-block-group__inner-container').style.color = "#000000";
    }
  });
